...
func initViper() (Constants, error) {
	...
	if os.Getenv("ENVIRONMENT") == "DOCKER" {
		viper.SetConfigName("MyProject_docker.config") // Configuration fileName without the .TOML or .YAML extension
	} else {
		viper.SetConfigName("MyProject.config") // Configuration fileName without the .TOML or .YAML extension
	}
